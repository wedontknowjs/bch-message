...
For more information refer to the [bch-message](https://github.com/owstack/bch-message) github repo.
...
```bash
npm install bch-message --save
```

For client-side projects:

```bash
bower install bch-message --save
```
