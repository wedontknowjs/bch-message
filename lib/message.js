...
var sha256sha256 = bchLib.crypto.Hash.sha256sha256;
...
/**
 * Will return a boolean of the signature is valid for a given bitcoin cash address.
 * If it isn't the specific reason is accessible via the "error" member.
 *
 * @param {Address|String} address - A bitcoin cash address
